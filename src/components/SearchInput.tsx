...
const SearchInput: React.FC<SearchInputProps> = ({
  ...
  return (
    <div className="flex w-full max-h-[40px] rounded-2xl">
      ...
      <button className=" bg-primary rounded-r-2xl text-white px-5 shadow-custom border border-solid border-[rgba(116,170,255,0.70)]" onClick={handleSearch}><IconSearch /></button>
    </div>
  );
};
