...
export default function ModalRegistroExitoso({ title, description, icon, iconSize, onClose }: ModalRegistroExitosoProps) {
            ...
            <div className="border-custom shadow-custom bg-[rgba(235,_236,_250,_1.00)] relative bg-white rounded-lg p-4 max-w-auto mx-auto">
              <div className="p-4">
                <div className="flex flex-col items-center justify-center">
                  ...
                  <p className="font-montserrat text-[35px] font-bold text-primary">{title}</p>
                  <p className="font-montserrat text-[18px] font-medium text-gray-700 mt-4 my-4 w-96 text-center">{description}</p>
                  <Button text="Aceptar" onClick={onClose} variant='call-to-action' />
                </div>
              </div>
            </div>
          </Transition.Child>
