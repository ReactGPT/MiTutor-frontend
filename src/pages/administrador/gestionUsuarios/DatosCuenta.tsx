      ...
      <div className='flex flex-row w-full h-full gap-2 h-[70%]'>
        <div className='flex flex-col w-[100%]'>
          <div className='flex flex-col gap-2'>
            ...
            <InputAdmin titulo="Código PUCP" text={user?.pucpCode} name="pucpCode" placeholder='Ingresa el código PUCP' enable={true} onChange={{ tipo: 'object', onChange: onChangeUser }} type='number'/>
