...
function DatosCuenta({ fieldErrors, setFieldErrors }: InputProps) {
      ...
      <div className='flex flex-row w-full gap-2 h-[70%]'>
        <div className='flex flex-col w-[100%]'>
          <div className='flex flex-col gap-2'>
            <InputAdmin titulo="Correo Institucional" text={user?.institutionalEmail} name="institutionalEmail" placeholder='Ingresa el correo institucional' enable={true} onChange={{ tipo: 'object', onChange: onChangeUser }} error={fieldErrors.institutionalEmail} />
            <InputAdmin titulo="Código PUCP" text={user?.pucpCode} name="pucpCode" placeholder='Ingresa el código PUCP' enable={true} onChange={{ tipo: 'object', onChange: onChangeUser }} error={fieldErrors.pucpCode} />
