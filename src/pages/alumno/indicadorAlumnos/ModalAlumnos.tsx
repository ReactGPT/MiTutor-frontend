...
const ModalAlumnos: React.FC<{ isOpen: boolean, onClose: () => void, students: Student[] }> = ({ isOpen, onClose, students }) => {
    const navigate = useNavigate();

    const handleStudentClick = (student: Student) => {
        navigate('/alumno-detail', { state: { student } });
    };
                ...
                <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0 " >
                    ...
                    >
                        <div className="inline-block align-bottom bg-blue-100 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle max-w-md w-full p-6">
                            <div className="mb-4">
                                <h2 className="text-xl font-semibold text-gray-800 text-center">Listado de Alumnos</h2>
                            </div>
                                    ...
                                    <ul className="divide-y divide-gray-200">
                                        {students.map((student) => (
                                            ...
                                            >
                                                ...
                                                <p className="text-gray-600">{student.usuario.institutionalEmail}</p>
                                            </li>
                                        ))}
                                    </ul>
                                ) : (
