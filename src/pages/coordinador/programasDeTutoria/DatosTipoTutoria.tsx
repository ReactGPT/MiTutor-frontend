...
function DatosTipoTutoria({className}:InputProps) {
  ...
  return (
    <div className={className}>
      <h2 className='text-xl w-full h-[15%] min-h-[50px] font-bold text-primary'>Tipo de Tutoría</h2>
      <div className='flex flex-col w-full h-full justify-between'>
        <div className='flex flex-row w-full h-full gap-4 max-h-[90px]'>
        ...
        <div className='flex flex-row w-full h-full gap-4  max-h-[90px] items-center'>
          <Toogle value={tutoringProgram.grupal} boxSize='w-[50%]' text='Grupal' onChange={()=>{
          ...
          <div className='flex flex-col w-[50%]'>
            <label className='me-2 text-sm font-medium text-primary dark:text-gray-300'>Cant. Integrantes</label>
