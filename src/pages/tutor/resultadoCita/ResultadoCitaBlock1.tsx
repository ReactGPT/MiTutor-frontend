...
function ResultadoCitaBlock1({className,nombreAlumno,onClickVerPerfil,onClickPlanAccion}:InputProps) {
  return (
    <div className={className}>
        <div className='flex w-[50%] h-full items-center border-custom drop-shadow-md px-4'>
            <span className='block truncate flex flex-row gap-2'>
        ...
        <div className='flex w-[50%] h-full justify-end items-center px-2 gap-4'>
            ...
            <Button icon={EyeIcon} iconSize={4} variant='call-to-action' text='Plan de Acción' onClick={onClickPlanAccion}/>
        </div>
    </div>
  )
}

export default ResultadoCitaBlock1