...
const getTutorMeetingRoom = (userData: { username: string; email: string; imageUrl: string; isLogged: boolean; token: string; userInfo: UserAccount | null; } | null) => {
  ...
  if (userData && userData.userInfo) {
    ...
    if (tutorRole && tutorRole.details) {
      ...
      return (tutorRole.details as TutorRoleDetails).meetingRoom;
    }
  }
  return null;
};

export { getTutorMeetingRoom };